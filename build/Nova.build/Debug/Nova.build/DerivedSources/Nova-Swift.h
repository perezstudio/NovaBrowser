...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Nova",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4Nova11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(Nova)) <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
@end

@interface AppDelegate (SWIFT_EXTENSION(Nova))
- (void)showAbout;
...
@class NSCoder;
SWIFT_CLASS("_TtC4Nova16CustomWebKitView")
@interface CustomWebKitView : NSView
...
@class NSWindow;
SWIFT_CLASS("_TtC4Nova19NativeBrowserWindow")
@interface NativeBrowserWindow : NSWindowController
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)toggleInspector;
- (void)showInspectorConsole;
- (void)showInspectorElements;
- (void)showInspectorSources;
- (void)windowDidLoad;
@end

SWIFT_CLASS("_TtC4Nova11SidebarView")
@interface SidebarView : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Nova29WebKitViewDelegateInterceptor")
@interface WebKitViewDelegateInterceptor : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC4Nova16WebViewContainer")
@interface WebViewContainer : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layout;
@end
